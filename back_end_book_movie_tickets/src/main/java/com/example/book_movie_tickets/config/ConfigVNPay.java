...
public class ConfigVNPay {
    ...
    public static String vnp_Returnurl = "https://spanish-memphis-market-shall.trycloudflare.com/api/payment/vnpay/vnpay-return"; //URL mà VNPay sẽ gọi lại sau khi thanh toán xong.
